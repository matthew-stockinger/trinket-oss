System.register(['./util/logging.js', './util/strings.js', './util/browser.js', './util/eventtarget.js', './display.js', './input/keyboard.js', './input/mouse.js', './websock.js', './des.js', './input/keysym.js', './input/xtscancodes.js', './inflator.js', './encodings.js', './util/polyfill.js'], function (_export, _context) {
    "use strict";

    var Log, decodeUTF8, supportsCursorURIs, isTouchDevice, EventTargetMixin, Display, Keyboard, Mouse, Websock, DES, KeyTable, XtScancode, Inflator, encodings, encodingName, DISCONNECT_TIMEOUT;
    function RFB(target, url, options) {
        ...
        this._screen.style.backgroundColor = 'rgb(249, 249, 249)';
        ...
        this._keyboard = new Keyboard(options.isMobile ? document.getElementById('noVNC_keyboardinput') : this._canvas);
    ...
    return {
        setters: [function (_utilLoggingJs) {
            Log = _utilLoggingJs;
        }, function (_utilStringsJs) {
            decodeUTF8 = _utilStringsJs.decodeUTF8;
        }, function (_utilBrowserJs) {
            supportsCursorURIs = _utilBrowserJs.supportsCursorURIs;
            isTouchDevice = _utilBrowserJs.isTouchDevice;
        }, function (_utilEventtargetJs) {
            EventTargetMixin = _utilEventtargetJs.default;
        }, function (_displayJs) {
            Display = _displayJs.default;
        }, function (_inputKeyboardJs) {
            Keyboard = _inputKeyboardJs.default;
        }, function (_inputMouseJs) {
            Mouse = _inputMouseJs.default;
        }, function (_websockJs) {
            Websock = _websockJs.default;
        }, function (_desJs) {
            DES = _desJs.default;
        }, function (_inputKeysymJs) {
            KeyTable = _inputKeysymJs.default;
        }, function (_inputXtscancodesJs) {
            XtScancode = _inputXtscancodesJs.default;
        }, function (_inflatorJs) {
            Inflator = _inflatorJs.default;
        }, function (_encodingsJs) {
            encodings = _encodingsJs.encodings;
            encodingName = _encodingsJs.encodingName;
        }, function (_utilPolyfillJs) {}],
        execute: function () {
            ...
            RFB.prototype = {
                ...
                _sendEncodings: function () {
                    ...
                    if (supportsCursorURIs() && !isTouchDevice && this._fb_depth == 24) {
