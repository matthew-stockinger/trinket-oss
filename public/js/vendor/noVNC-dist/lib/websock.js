System.register(['./util/logging.js'], function (_export, _context) {
    "use strict";

    var Log, ENABLE_COPYWITHIN, MAX_RQ_GROW_SIZE, typedArrayToString;
    function Websock() {
        "use strict";
    ...
    return {
        ...
        execute: function () {
            ...
            ENABLE_COPYWITHIN = false;
            MAX_RQ_GROW_SIZE = 40 * 1024 * 1024;

            typedArrayToString = function () {
