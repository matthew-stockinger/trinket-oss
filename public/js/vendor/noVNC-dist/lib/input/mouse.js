System.register(['../util/logging.js', '../util/browser.js', '../util/events.js'], function (_export, _context) {
    "use strict";

    var Log, isTouchDevice, setCapture, stopEvent, getPointerEvent, WHEEL_STEP, WHEEL_STEP_TIMEOUT, WHEEL_LINE_HEIGHT;
    ...
    return {
        ...
        }, function (_utilEventsJs) {
            setCapture = _utilEventsJs.setCapture;
            stopEvent = _utilEventsJs.stopEvent;
            getPointerEvent = _utilEventsJs.getPointerEvent;
        }],
        execute: function () {
            WHEEL_STEP = 10;
            WHEEL_STEP_TIMEOUT = 50;
